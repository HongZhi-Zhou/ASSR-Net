...
# from Models.VGSR.VGSR import VGSR_NET
from Model.ASSR.VGSR import VGSR_NET
# from Models.LRTN import Cross_Guide_Fusion
# from Models.DSP import DSPNet
# from Train_SIF.Model import Net
# from Train_DHIF.Model import HSI_Fusion
# from SRLF_Net_main.mambair import *
# from SRLF_Net_main.deep_select_mamba import *
...
# model_path = r'PKL/Cave/MIMO/2/cave_pkl/1000EPOCH_RMSE_best.pkl'
model_path = r'PSNR_best.pkl'
# model_path = r'SRLF_Net_main/train_save/deep_select_mamba/3/cave_pkl/2000EPOCH_RMSE_best.pkl'
...
RealSavePath = './result/VGSR_Net/Cave/Rea_2/'
FakSavePath = './result/VGSR_Net/Cave/Fak_2/'
...
# net2 = otias_c_x8(n_select_bands=3,n_bands = 31,feat_dim=128,guide_dim=128,sz = 64).cuda()
# net2 = Cross_Guide_Fusion(31,64,64,1).cuda()
...
# net2.load_state_dict(checkpoint, strict=False)
